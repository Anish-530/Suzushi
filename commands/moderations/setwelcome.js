...
module.exports={
    name: 'setwelcome',
    category: 'guild',
    description: 'set the welcome channel, guess what? We have a beautiful welcome Canvas',
    aliases: ['swc', 'setwc'],
    usage: 'su setwelcome <mention a channel>',
    run: async(bot, message, args)=>{
        ...
        if(!channel) {
            ...
            try {
                ...
                .setDescription(`<:good:776121655528783964> Welcome channel for **${message.guild.name}**, is now set as ${chan}`)
                .setColor('#2f3136')
