...
module.exports={
    name: 'testwelcome',
    category: 'guild',
    description: 'test the amazing welcome canvas',
    aliases: ['twc'],
    usage: 'su testwelcome [mention someone]',
    run: async(bot, message, args)=>{
        ...
        let ch = db.fetch(`welchannel_${message.guild.id}`);
        ...
        try{
                ...
                ctx.fillText(`Welcome To ${message.guild.name}`, 210, 60);
                do{
